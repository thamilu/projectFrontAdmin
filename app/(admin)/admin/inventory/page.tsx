...
import { useAdminInventory } from '@/features/admin/inventory/hooks/use-admin-inventory';
import type { AdminProduct } from '@/features/admin/inventory/types';
    ...
    <AdminGuard>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="bg-orange-50/50 border-orange-100">
            ...
            <CardContent className="flex justify-between items-end">
              <div className="text-2xl font-bold text-orange-700">
                {inventory.filter((i: AdminProduct) => new InventoryItem(i.id, i.sku || 'N/A', i.stockQuantity).isLowStock(10)).length}
              </div>
              <Button
                variant="link"
          ...
          <StatCard
            title="Out of Stock"
            value={inventory.filter((i: AdminProduct) => new InventoryItem(i.id, i.sku || 'N/A', i.stockQuantity).quantity === 0).length}
