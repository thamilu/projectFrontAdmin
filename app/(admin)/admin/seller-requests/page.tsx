...
import { useSellerRequests } from '@/features/admin/seller-requests/hooks/use-seller-requests';
import { getColumns } from './columns';
import { SellerDetailsDrawer } from '@/features/admin/seller-requests/components/seller-details-drawer';
import { RejectDialog } from '@/features/admin/seller-requests/components/reject-dialog';
import { ApproveDialog } from '@/features/admin/seller-requests/components/approve-dialog';
...
export default function SellerRequestsPage() {
  ...
  const filteredRequests = requests?.filter((r: SellerRequest) =>
