...
// import { cn } from '@/shared/utils/utils'; // Not used in provided snippet but good practice
import type { RecentOrder, OrderStatus } from '@/features/admin/analytics/types';
...
function OrderItem({ order }: { order: RecentOrder }) {
  ...
  return (
    <Link
      href={APP_ROUTES.ADMIN.ORDER_DETAIL(order.id)}
      className="flex flex-col gap-2 rounded-lg border p-3 hover:bg-muted/50 transition-colors group"
    >
